...
function mainTitleSpanish() {
    ...
    return (
        <main className={`w-[100%] h-[100%]  ${(context.screenView == '1' ?  'onScreenStyle' : 'offScreenStyle')}`}>
            <div className='SpanishMenuTitleMainBox'>
                ...
                <div className='menuButtonsBox'>
                    <div className='aboutMyButton'>
                        <h2 onClick={()=> {context.setScreenView('3');}}>Sobre mí</h2>
                    </div>

                    <div className='myExpButton'>
                        <h2 onClick={()=> {context.setScreenView('4');}}>Mi experiencia</h2>
                    </div>

                    <div className='mySkillsButton'>
                        <h2 onClick={()=> {context.setScreenView('5');}}>Mis habilidades</h2>
                    </div>

                    <div className='contactButton'>
                        <h2 onClick={()=> {context.setScreenView('6');}}>Contacto</h2>
                    </div>
                </div>
            </div>
